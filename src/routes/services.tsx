...
const services = [
  { icon: Code2, t: "Web Development", d: "Modern web apps with React, Next.js, TanStack — engineered for scale, speed and SEO.", tags: ["React", "TanStack", "Node"] },
  ...
  { icon: Cpu, t: "Custom Software", d: "Bespoke platforms tailored to your operations — ERP, dashboards, marketplaces.", tags: ["SaaS", "ERP", "Portals"] },
