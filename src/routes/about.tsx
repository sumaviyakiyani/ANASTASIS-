...
const values = [
  ...
  { icon: Heart, t: "Care", d: "Users, teammates and code, all treated with respect." },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        subtitle="Anastasis is Greek for resurrection. We bring dormant potential back to life through research, code and craft."
      />
      ...
      <Section>
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            <div key={b.t} className="p-7 sm:p-10 rounded-3xl neu-card group hover:shadow-glow transition">
      ...
      <Section>
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="mt-3 text-3xl sm:text-4xl md:text-5xl font-bold">A story of <span className="text-gradient-brand">recursion</span></h2>
        </div>
      ...
      <Section className="bg-gradient-dark text-ink relative overflow-hidden">
        ...
        <div className="relative text-center max-w-2xl mx-auto">
          ...
          <h2 className="mt-3 text-3xl sm:text-4xl md:text-5xl font-bold">What guides <span className="text-gradient-brand">every decision</span></h2>
        </div>
        <div className="relative mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {values.map((v) => (
            <div key={v.t} className="glass-dark p-6 sm:p-8 rounded-3xl hover:bg-brand/10 hover:-translate-y-1 transition">
