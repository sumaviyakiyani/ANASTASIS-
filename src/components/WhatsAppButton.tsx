...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-4 z-[60] inline-flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-3 font-semibold text-white shadow-glow transition-transform hover:scale-105 sm:bottom-6 sm:right-6"
    >
